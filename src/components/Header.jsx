		...
		<>
			<header className="sticky top-0 z-20 border-b border-purple-900/40 bg-black">
				<div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 lg:px-6">
					...
					<div className="flex items-center gap-2">
						<Link className="flex h-10 w-10 items-center justify-center rounded-full text-purple-300 transition-all duration-300 hover:scale-105 hover:bg-purple-900/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-600/60" to="/help">
